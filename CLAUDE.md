...
- `starsim_plugin/` - Claude Code plugin for Starsim (MCP tools and modeling skills).
- `disease_modeling_plugin/` - Claude Code plugin for general disease modeling (WIP).
